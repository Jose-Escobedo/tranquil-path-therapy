...
export default function AboutTeamSection() {
 const teamMembers = [
  ...
  <Link key={index} href={`/about/${member.slug}`} passHref>
    <div className="relative group overflow-hidden rounded-lg shadow-lg cursor-pointer transition-transform transform hover:scale-105 hover:ring-4 hover:ring-[var(--gold)] hover:ring-opacity-50">
      <Image
        src={member.image}
        alt={member.name}
        width={400}
